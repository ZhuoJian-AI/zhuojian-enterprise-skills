...
class RuntimeHostTests(unittest.TestCase):
    ...
    def test_enterprise_keys_are_generic_and_legacy_alphabet_is_accepted(self):
        ...
        self.assertEqual(runtime_admin.canonical_enterprise_key("zhipu"), "zhipu")
        with self.assertRaises(runtime_admin.AdminError):
            runtime_admin.canonical_enterprise_key("zhi_pu")
