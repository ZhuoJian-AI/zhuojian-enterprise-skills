#!/usr/bin/env python3
"""Validate an enterprise local-disk or OSS file-storage runtime profile."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="校验企业 ECS 的本地硬盘或 OSS 文件存储档案"
    )
    ...
    print(
        ...
        f"Enterprise file storage mode is {selected_mode}"
    )
    return 0
