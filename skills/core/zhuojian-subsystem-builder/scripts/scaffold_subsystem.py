...
def main() -> int:
    ...
    parser.add_argument("--company-slug", required=True, help="来自 Runtime enterpriseKey 的企业稳定英文标识")
    parser.add_argument("--company-name", required=True, help="企业显示名称")
    ...
    replacements = {
        ...
        "__COMPANY_NAME__": args.company_name.strip(),
